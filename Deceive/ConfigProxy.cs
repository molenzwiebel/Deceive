        ...
        private async Task ProxyAndRewriteResponse(string configUrl, int chatPort, IHttpContext ctx)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(
                    ...
                    "Please check if there's a new version of Deceive available, or contact the creator through GitHub (https://github.com/Ponita0/HideMyApp) or Discord if there's not.\n\n" +
                    ex,
